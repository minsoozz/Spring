...
<jsp:getProperty property="arrow" name="ubbs"/>
		<a href="bbsdetail.do?seq=${board.seq}">${board.title}</a></td>
		<td>${board.wdate}</td>
...
$(function() {
	$("#write").click(function() {
		location.href = "writeAf.do";
	});
	
	$("#searchbtn").click(function() {

		location.href="getBoardList.do?pageNum=1&keyword="+$("#searchtxt").val()+"&cond="+$("#select option:selected").val();
		
	});
	
	//검색 조건이 없을 때 페이징 네비게이션
	$(".pagingNavItem").click(function(){
		location.href='getBoardList.do?pageNum=' + $(this).text();
	});
	...
	$(".pagingNavItemWithSearchCond").click(function(){
		...
		location.href='getBoardList.do?pageNum=' + $(this).text() + '&cond=' + cond + '&keyword=' + keyword; 
	});
